...
/* [문제 설명]
* ㅇㅇ시에서는 저수지가 하나 있는데, 도시 내에서 사용하는 모든 물은
...
* 월별 물 사용량이 전 달 대비 어떻게 변하는지 저장된
* 정수 리스트 change가 주어질 때 몇 달 뒤 물이 부족해지는지
...
*
* 다음 달 물 사용량은 이번달 사용량 550에서 10% 감소한 495 이며,
* 나머지 달도 동일하게 계산합니다.
*
...
*
* 입출력 예 #2
* 총 사용가능한 물의 양이 1000인데 2000 * 0.9 = 1800이 필요하므로
* 이번 달부터 물이 부족합니다.
* 따라서 0을 return합니다.
*
